...
const CreateBattle = () => {
  ...
  return <div className="min-h-screen">
      ...
      <div className="max-w-6xl mx-auto p-3 lg:p-6">
            ...
            <CardContent>
              <div className="mb-4">
                ...
                <Select value={winnerStigma} onValueChange={setWinnerStigma}>
                  ...
                  <SelectContent>
                    {stigmas.map(stigma => <SelectItem key={stigma.id} value={stigma.id}>
        ...
        <div className="mt-3 lg:mb-6 flex items-center justify-between lg:justify-end gap-6 ">
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap-reverse ">
            <div className="flex-1 max-w-[300px]">
              <div className="relative">
                ...
                <Input value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-4 md:pl-10 bg-card border-border " />
              </div>
            </div>
