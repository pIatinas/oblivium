      ...
      <div className="max-w-6xl mx-auto p-3 md:p-6 ">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-6">
            ...
            <Button asChild variant="ghost" className="bg-card">
              <Link to="/knights">
                Ver Todos
              </Link>
            </Button>
            ...
            <Carousel className="w-full">
              <CarouselContent>
                {topKnights.map(knight => (
                  <CarouselItem key={knight.id} className="basis-1/2">
                    <Link to={`/knights?knight=${knight.id}`}>
          ...
          {/* Desktop Grid */}
          <div className="hidden md:grid gap-2 mgap-6 grid-cols-2 lg:grid-cols-5 xl:grid-cols-6">
