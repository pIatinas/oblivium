        ...
        <div className="mb-6 flex flex-col-reverse sm:flex-row gap-4 items-center justify-between flex-wrap-reverse w-full ">
          <div className="flex gap-4 flex-1 w-full ">
            <div className="relative flex-1">
              ...
              <Input ref={searchInputRef} value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 bg-card border-border" />
            </div>
          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            <DialogTrigger asChild>
              <Button className="bg-gradient-cosmic text-white hover:opacity-90 md:ml-auto">
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle className="text-left font-light">Cadastro de Cavaleiro</DialogTitle>
              </DialogHeader>
