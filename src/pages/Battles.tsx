...
const Battles = () => {
  ...
  const fetchData = async () => {
    try {
      await Promise.all([fetchBattles(), fetchKnights(), fetchStigmas(), fetchProfiles()]);
    } catch (error) {
      ...
      <div className="max-w-6xl mx-auto p-3 lg:p-6">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            <Input placeholder="Buscar por cavaleiro..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 bg-card border-border" />
          </div>
