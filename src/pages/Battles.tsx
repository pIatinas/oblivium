                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <h3 className="text-accent font-semibold text-center flex flex-col items-center gap-2">
                      Vencedor
                      {battle.winner_team_stigma && <img src={getStigmaById(battle.winner_team_stigma)?.imagem} alt="Estigma do time vencedor" className="w-8 h-8" />}
                    </h3>
                    ...
                    return knight ? <div key={index} className="flex flex-col items-center gap-1 cursor-pointer" onClick={e => {
                      ...
                      window.location.href = `/knights?knight=${knight.id}`;
                            ...
                            <img src={knight.image_url} alt={knight.name} className="w-10 h-10 rounded-full border border-accent/20 hover:border-accent/40" />
                  ...
                  <div className="flex-1 space-y-3">
                    <h3 className="text-purple-400 font-semibold text-center flex flex-col items-center gap-2">
                      Perdedor
                      {battle.loser_team_stigma && <img src={getStigmaById(battle.loser_team_stigma)?.imagem} alt="Estigma do time perdedor" className="w-8 h-8" />}
                    </h3>
                    <div className="flex gap-2 justify-center">
                    ...
                    return knight ? <div key={index} className="flex flex-col items-center gap-1 cursor-pointer" onClick={e => {
                      ...
                      window.location.href = `/knights?knight=${knight.id}`;
                            ...
                            <img src={knight.image_url} alt={knight.name} className="w-10 h-10 rounded-full border border-purple-400/20 hover:border-purple-400/40" />
