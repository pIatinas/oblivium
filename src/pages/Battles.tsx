        ...
        {filteredBattles.length > 0 ? <>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2 ">
              {filteredBattles.map(battle => <Card key={battle.id} className="bg-card hover:bg-card/80 transition-all duration-300 relative border-none shadow-none cursor-pointer" onClick={() => window.location.href = `/battles/${battle.id}`}>
                  ...
                  {isAdmin && <div className="absolute top-2 right-2 z-20">
                      <AlertDialog>
                        ...
                        <AlertDialogContent>
                          ...
                          <AlertDialogFooter>
                            ...
                            <AlertDialogAction onClick={() => deleteBattle(battle.id)} className="bg-destructive text-destructive-foreground hover:bg-destructive/90">
                              Excluir
                            </AlertDialogAction>
                          </AlertDialogFooter>
                        </AlertDialogContent>
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      return knight ? <div key={index} className="flex flex-col items-center gap-1 cursor-pointer" onClick={e => {
                        ...
                        window.location.href = `/knights?knight=${knight.id}`;
                                ...
                                <img src={knight.image_url} alt={knight.name} className="w-14 h-14 rounded-full border border-accent/20 hover:border-accent/40" />
                      ...
                      return knight ? <div key={index} className="flex flex-col items-center gap-1 cursor-pointer" onClick={e => {
                        ...
                        window.location.href = `/knights?knight=${knight.id}`;
                                ...
                                <img src={knight.image_url} alt={knight.name} className="w-14 h-14 rounded-full border border-purple-400/20 hover:border-purple-400/40" />
