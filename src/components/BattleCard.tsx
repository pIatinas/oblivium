...
const BattleCard = ({
  ...
  return (
    <Card className="bg-card hover:bg-card/70 hover:scale-105 transition-all duration-300 relative border-none shadow-none cursor-pointer group">
      {battle.meta && (
          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="flex gap-2 justify-center">
              {battle.winner_team.slice(0, 3).map((knightId, index) => {
                ...
                const isSelectedKnight = selectedKnightId === knightId;
                ...
                return knight ? (
                  ...
                  >
                    <img 
                      ...
                      alt={knight.name} 
                      className={`w-8 h-8 lg:w-14 lg:h-14 rounded-full border-2 ${
                        isSelectedKnight 
                          ? 'border-white' 
